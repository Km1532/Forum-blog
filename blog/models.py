...
class Blog(models.Model):
    ...
    likes = models.ManyToManyField(CustomUser, related_name='liked_posts', blank=True, verbose_name="Лайки", through='PostLike')
    dislikes = models.ManyToManyField(CustomUser, related_name='disliked_posts', blank=True, verbose_name="Дизлайки", through='PostDislike')
...
class Comment(models.Model):
    ...
    likes = models.ManyToManyField(CustomUser, related_name='liked_comments', blank=True, verbose_name="Лайки", through='CommentLike')
    dislikes = models.ManyToManyField(CustomUser, related_name='disliked_comments', blank=True, verbose_name="Дизлайки", through='CommentDislike')
